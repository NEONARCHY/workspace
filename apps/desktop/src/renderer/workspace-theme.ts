...
export const workspaceTheme: Theme = {
  ...
  colorNeutralBackground1: "var(--ws-surface, #fcfdfd)",
  colorNeutralBackground2: "var(--ws-muted-surface, #f2f6f6)",
  colorNeutralStroke1: "var(--ws-control-line, #b8c9ce)",
  colorNeutralStroke2: "var(--ws-line, #e1e9eb)",
  borderRadiusSmall: "6px",
  borderRadiusMedium: "var(--ws-control-radius, 12px)",
  borderRadiusLarge: "16px",
  borderRadiusXLarge: "var(--ws-radius, 22px)",
};
