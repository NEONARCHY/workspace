...
Alpha 0.4.0 закрепляет девять разделов рабочего Bitrix в общей навигации и добавляет организационный справочник поверх настоящего контура учётных записей:
