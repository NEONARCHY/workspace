...
## Первая desktop-альфа

Alpha 0.1.0 объединяет три интерактивных раздела:

- корпоративный мессенджер с чатами, поиском и тестовой отправкой сообщений;
- задачи с фильтрами, карточкой, созданием и сменой статуса;
- заявки на оплату и визуальный редактор последовательных, параллельных, условных и возвратных этапов согласования.

Сейчас интерфейс использует типизированные демонстрационные данные. PostgreSQL-модель уже создана миграцией `0003_corporate_core`; следующий шаг — постоянный FastAPI API, авторизация и WebSocket-синхронизация.
