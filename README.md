...
Alpha 0.6.0 добавляет полноценный рабочий контур задач поверх связанного процесса alpha 0.5.0. Сообщение становится задачей, задача — заявкой, а файлы и исправления сохраняются с проверяемой историей:
