...
Alpha 0.5.0 превращает базовый контур в связанный рабочий процесс: сообщение становится задачей, задача — заявкой, а файлы и исправления сохраняются с проверяемой историей. Навигация и организационный справочник alpha 0.4.0 остаются частью сборки:

- корпоративный мессенджер с чатами, поиском, отправкой, вложениями и действием «создать задачу из сообщения»;
- задачи с фильтрами, карточкой, файлами, исходным сообщением и действием «создать заявку на оплату»;
- заявки на оплату с обязательной видимой причиной возврата, редактированием полей и документов, неизменяемыми версиями и повторной отправкой;
